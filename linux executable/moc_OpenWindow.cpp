...
#include "../SPACEDEFENSE/OpenWindow.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_OpenWindow_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 24, 13)
    ...
    "OpenWindow\0onClickPlay\0\0onClickInstru"
};
...
void OpenWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->onClickPlay(); break;
        case 1: _t->onClickInstru(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject OpenWindow::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_OpenWindow.data,
      qt_meta_data_OpenWindow,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_OpenWindow.stringdata))
        return static_cast<void*>(const_cast< OpenWindow*>(this));
